...
const SECTIONS: Section[] = [
  {
    ...
    topics: [
      ...
      { num: '02', to: '/pathfinding', title: 'Pathfinding', subs: 'bfs · dfs · dijkstra · a*' },
      { num: '03', to: '/graph', title: 'Graph', subs: 'kruskal · prim · topo · tarjan scc' },
    ],
  },
  {
    title: 'Advanced',
    intro: 'Data structures and protocols that don’t usually get a friendly UI.',
    topics: [
      { num: '04', to: '/advanced/bloom', title: 'Bloom filter', subs: 'probabilistic membership' },
      { num: '05', to: '/advanced/hyperloglog', title: 'HyperLogLog', subs: 'cardinality estimation' },
      { num: '06', to: '/advanced/skiplist', title: 'Skip list', subs: 'probabilistic ordering' },
      { num: '07', to: '/advanced/lru', title: 'LRU cache', subs: 'bounded recency' },
      { num: '08', to: '/advanced/raft', title: 'Raft consensus', subs: 'leader election' },
      { num: '09', to: '/advanced/trie', title: 'Trie', subs: 'prefix tree' },
      { num: '10', to: '/advanced/unionfind', title: 'Union-Find', subs: 'dynamic connectivity' },
    ],
  },
];
    ...
    <div className="px-10 lg:px-16 py-16 max-w-3xl">
      <header className="mb-16">
        ...
        <p className="mt-6 max-w-xl text-[15.5px] leading-relaxed text-ink-dim">
          Each algorithm runs as a generator that yields one step at a time.
          Pause anywhere. Drop the speed. Walk through a tricky branch and
          watch the pseudocode highlight as it executes.
        </p>
      </header>
